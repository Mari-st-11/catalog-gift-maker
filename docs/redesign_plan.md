...
- [ ] デザインテーマ（mode/botanical/nuance）に応じた画面デザインの作り直し
      ...
      **贈り主側（ログイン必須）**
      ...
      7. ギフトリスト編集 (`/gift_lists/:uuid/edit`) — リスト名・メッセージ編集(ウィザードのステップ3)
      8. ギフトアイテム新規登録 (`/gift_lists/:uuid/gift_items/new`) — URL入力 or 手動入力(ウィザードのステップ2)。
      ...
      **その他**
      ...
      14. 共通ヘッダー/フッター（ログイン状態に応じた表示切り替え） — まだ旧デザインのまま
